...
@section('content')
	<div class="page">
		<div class="container">
			...
			<p>
				PT KAKA JAYA INDONUSA KONSTRUKSI bergerak di bidang jasa konsultasi teknik dan manajemen yang menyediakan bantuan dan pelayanan terhadap klien dalam melaksanakan 
				berbagai kegiatan yang berkaitan di bidang perencanaan umum, studi kelayakan, perencanaan 
			...
			<p>
				...
				pelannggan dengan menggunakan system teknik dan administrasi secara professional dengan 
				di dukung oleh tenaga ahli yang berpengelaman di bidangnya dan dibantu oleh tenaga muda 
				yang berbakat dan memiliki high potential and quality serta On Time di dalam setiap 
				pelaksanaannya dengan tujuan agar terjaminnya sasaran kebutuhan klien secara maksimal dan 
			...
			<p>
				...
				komitmen penuh untuk menyediakan solusi yang terbaik untuk pelanggan dan tidak pernah 
				berhenti dalam melakukan penyempurnaan unsur -unsur pendukungnya dengan pengembangan 
